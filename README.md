...
```bash
# Generate PHP models from an OpenAPI spec
cdd-php from_openapi to_sdk -i spec.json -o src/models

# Generate an OpenAPI spec from your PHP code
cdd-php to_openapi -f src/models -o openapi.json
```
