...
| :--- | :---: | :---: | :---: | :--- |
| **OpenAPI Object (Root)** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | Root CLI definition |
...
| **Info Object** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | CLI `--help` text, `--version` command |
| **Info Object (`title`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | TODO |
| **Info Object (`summary`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | Short summary for CLI global help text |
...
| **Server Object** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | Global `--server` or `--host` flag mapping |
| **Server Object (`url`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | TODO |
| **Server Object (`description`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | TODO |
| **Server Object (`name`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | Unique name used as CLI alias for a host environment |
...
| **Components Object** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | Reusable flag groups or interactive prompt states |
...
| **Paths Object** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | Structural mapping to CLI namespaces |
...
| **Media Type Object** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | Inferred based on payload flag logic |
...
| **Responses Object** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | Determines Exit Codes (`0` vs `1`, etc.) |
...
| **Response Object (`summary`)** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | Subcommand exit status short description |
...
| **Tag Object** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | High-level CLI command groups (e.g. `cli [tag] [operation]`) |
...
| **Discriminator Object** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | Mutually exclusive flag groups based on type |
...
| **OAuth Flows Object** | `[x]` , `[x]` | `[x]` , `[x]` | `[ ]` , `[ ]` | CLI token manager / local keychain integration |
